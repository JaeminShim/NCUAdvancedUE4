...
*/
	...
	public void AndroidThunkJava_CallTest()
	{
		Log.debug("[JAVA] - CallTest");
	}
	
	public String AndroidThunkJava_GetPhoneNumber()
	{
		TelephonyManager telephony = (TelephonyManager)getSystemService(Context.TELEPHONY_SERVICE);
		String telPhoneNo = telephony.getLine1Number();
		Log.debug("[JAVA] - " + telPhoneNo);
		return nativeGetPhoneNumber(telPhoneNo);
	}
	...
	public native String nativeGetPhoneNumber(String phoneNo);
